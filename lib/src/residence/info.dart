...
class Info extends StatefulWidget {
  static final GlobalKey<_InfoState> _infoState = GlobalKey();

   Info({Key? key}) : super(key: _infoState);
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: subResidents.map((e) => Text(e.name, style: TextStyle(color: mainColor),)).toList()
                ),
              ),
            ),
          )
