                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            BarcodeWidget(
                                              color: mainColor,
                                              data:  ' Name - '+ ((gatePassdetail?.attr!['visitor'] is String)? gatePassdetail!.attr!['visitor']! : '')+';'
                                                  +'\n Vehicle Plate - ' + ((gatePassdetail?.plate_number is String)? gatePassdetail!.plate_number! : '')+';'
                                                  +'\n Id - ' + ((gatePassdetail?.id is String)? gatePassdetail!.id! : '')+';'
